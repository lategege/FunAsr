...
'''
Namespace(host='192.168.0.39', port=10095, chunk_size=[5, 10, 5], 
chunk_interval=10, hotword='', audio_in='../audio/asr_example.wav', 
send_without_sleep=True, thread_num=1, words_max_print=10000, 
output_dir=None, ssl=1, use_itn=1, mode='offline')
'''


"""
python3 funasr_wss_client.py --host "192.168.0.39" --port 10095 --mode offline --audio_in "../audio/asr_example.wav"
"""
